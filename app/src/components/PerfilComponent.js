...
const Perfil = () => {
        ...
        return (
          <div className="flex flex-col justify-center items-center gap-[20px] pb-[20px] lg:pl-[100px] lg:pr-[100px]">
            ...
            <div className="flex justify-center lg:justify-center items-center w-[50vh]">
              <div className="relative w-[150px] h-[150px] lg:float-right">
                <button
                  ...
                  className="bg-[white] text-[#1AA9FF] p-2 mt-[75%] ml-[75%] rounded-full absolute"
                >
                ...
                <img
                  src={imagenPerfil}
                  alt="imagen de perfil"
                  className="w-full h-full p-[10px] border-[2px] rounded-full"
                />
                <input
                  type="file"
                  accept="image/*"
            ...
            <form className="w-[50%] flex flex-col gap-[20px] items-center">
              ...
              <button
                type="submit"
                className="bg-[white] w-[120px] lg:w-[150px] h-[40px] hover:bg-[#1AA9FF] hover:border-[white] hover:border-[1px] text-[black] rounded"
              >
                Actualizar
              </button>
            </form>
            ...
            <div className="flex w-[50%] lg:flex-row flex-col justify-between items-center">
              ...
              <button className="bg-[white] w-[150px] h-[40px] hover:bg-[#1AA9FF] hover:border-[white] hover:border-[1px] text-[black] rounded">
                Cambiar contraseña
              </button>
            </div>
            <hr className="underline w-[50%]"></hr>
            <div className="flex lg:flex-row flex-col w-[50%] gap-[10px] text-center justify-between lg:items-start lg:text-start items-center">
              <div>
                ...
                <p className="text-[#545454]">
                  Si eliminas la cuenta no podrás recuperarla
                </p>
              </div>
              <button className="bg-[white] w-[150px] h-[40px] hover:bg-[darkred] hover:text-[white] hover:border-[white] hover:border-[1px] text-[red] rounded">
                Borrar Cuenta
              </button>
            </div>
          </div>
            ...
            <div className="flex flex-wrap lg:flex-row w-full justify-center items-center gap-[30px] md:justify-center lg:justify-between lg:pl-[100px] lg:pr-[100px]">
              <div className="bg-[white] text-[black] w-[45vh] md:w-[50vh] flex items-center justify-between p-[20px] rounded-[20px]">
                <img
                  src={twitter}
                  alt="Logo de Twitter"
                  className="bg-[black] rounded-[10px] p-[7px] w-[50px] h-[50px]"
                />
                <div>
                  <h1 className="text-[25px]">X</h1>
                  <p className="text-[#545454]">No conectado</p>
                </div>
                <button className="bg-[#1AA9FF] h-[40px] w-[30%] rounded-full text-[white] hover:bg-[white] hover:text-[#1AA9FF] hover:border-[#1AA9FF] hover:border-[1px]">
                  Conectar
                </button>
              </div>
              <div className="bg-[white] text-[black] w-[45vh] md:w-[50vh] flex items-center justify-between p-[20px] rounded-[20px]">
                <img
                  src={discord}
                  alt="Logo de Discord"
                  className="rounded-[10px] p-[7px] w-[60px] h-[60px]"
                />
                <div>
          ...
          <div className="flex flex-col gap-[20px] w-full justify-center items-center">
            ...
            <div className="flex flex-col lg:flex-row lg:flex-wrap items-center gap-[50px] static px-[80px]">
              {cuentas.map((cuenta, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-t w-[40vh] h-[50vh] lg:h-[50vh] p-[10px] md:h-[35vh] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]"
                >
                  ...
                  <div className="flex flex-col gap-[20px]">
                    ...
                    <div className="flex flex-row justify-between items-center w-full px-[30px]">
                      <button className="bg-[lightseagreen] rounded-full w-[70px]">
                        <a>Editar</a>
                      </button>
                      <button className="bg-[#c41010] rounded-full w-[70px] ">
                        <a>Eliminar</a>
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex flex-col gap-[20px]  w-full justify-center items-center">
            ...
            <div className="flex flex-col lg:flex-row lg:flex-wrap items-center gap-[50px] static px-[80px]">
              {recompensas_canjeadas.map((canjeada, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-t w-[40vh] md:h-[30vh] h-[25vh] p-[10px] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]"
                >
                  <img
                    src={canjeada.imagen}
            ...
            <div className="flex flex-col gap-[20px] lg:w-[50%] justify-center items-center">
              ...
              <div className="flex flex-wrap justify-center w-full gap-[20px] static">
                {misiones_completadas.map((completada, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-t w-[40vh] h-[25vh] lg:h-[40vh] p-[10px] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]"
                  >
                    <img
                      src={completada.imagen}
                      className="w-full md:h-[60%] h-[40%]"
                    />
                    <div className="flex flex-col gap-[20px]">
            ...
            <div className="flex flex-col gap-[20px] lg:w-[50%] justify-center items-center">
              ...
              <div className="flex w-full flex-wrap justify-center gap-[20px] static">
                {recompensas_solicitadas.map((solicitada, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-t w-[40vh] lg:h-[40vh] h-[25vh] p-[10px] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]"
                  >
                    <img
                      src={solicitada.imagen}
                      className="w-full md:h-[60%] h-[40%]"
                    />
                    <div className="flex flex-col gap-[20px]">
          ...
          <div className="flex flex-col gap-[20px] w-full justify-center items-center">
            ...
            <div className="flex flex-col lg:flex-row lg:flex-wrap items-center gap-[50px] px-[80px]">
              {pedidos.map((pedido, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-t w-[40vh] lg:h-[50vh] h-[55vh] md:h-[40vh] p-[10px] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]"
                >
  ...
  return (
    <div className="bg-blue-900 min-h-[100vh] text-[white] flex flex-col font-roboto-condensed gap-[35px] w-full pt-[30px] lg:p-0">
      ...
      <button
        className="lg:hidden w-full flex flex-col items-center justify-center "
      ...
      <div
        className={`lg:hidden absolute ${isOpen ? 'block' : 'hidden'} w-full relative bg-blue-900 h-full flex flex-col justify-center items-center mt-4 gap-[20px]`}
      >
        <a
          href="/"
          className="text-white no-underline rounded transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:bg-white/10"
        >
          Inicio
        </a>
        <a
        ...
        <button
          onClick={() => [setOpcionSeleccionada('perfil'), handleLinkClick()]}
        ...
        <button
          onClick={() => [
            setOpcionSeleccionada('inventario'),
            handleLinkClick(),
          ]}
        ...
        <button
          onClick={() => [setOpcionSeleccionada('logros'), handleLinkClick()]}
          className={getButtonClass('logros')}
        >
          Logros
        </button>
        <button
          onClick={() => [setOpcionSeleccionada('pedidos'), handleLinkClick()]}
        ...
        <button
          onClick={() => [
            setOpcionSeleccionada('cuentas de juego'),
            handleLinkClick(),
          ]}
          className={getButtonClass('cuentas de juego')}
        >
          Cuentas de juego
        </button>
        <button
          onClick={() => [
            setOpcionSeleccionada('conexiones'),
            handleLinkClick(),
          ]}
          className={getButtonClass('conexiones')}
        >
          Conexiones
        </button>
        <button
          onClick={() => [setOpcionSeleccionada('cuenta'), handleLinkClick()]}
          className={getButtonClass('cuenta')}
        >
          Editar Perfil
        </button>
      </div>
      ...
      <footer className="w-full bg-neutral-900">
        <div
          id="contenido_footer"
          className="flex justify-between items-center text-center lg:items-start flex-col lg:flex-row gap-4 p-10 max-w-[1200px] mx-auto"
        >
