...
const Contenido = () => {
  ...
  const closeModal = () => {
    ...
    const porcentaje =
      (modalVideoTime / document.getElementById("modalVideo").duration) * 100;
  ...
  return (
    <div className="font-sans bg-blue-900 text-black m-0 p-0">
      ...
      {modalVisible && (
        <div
          id="videoModal"
          className="modal fixed z-50 left-0 top-0 w-full h-full overflow-auto bg-black bg-opacity-80"
        >
          <div className="modal-content relative m-auto p-0 w-4/5 max-w-2xl top-1/2 transform -translate-y-1/2">
            <div className="button-container">
              <button
                className="close-button absolute top-2.5 right-6 bg-transparent border-none text-white text-3xl cursor-pointer"
                onClick={closeModal}
              >
                &times;
              </button>
              <button
                className="share-button mt-5 p-2.5 bg-blue-300 text-black border-none rounded-md cursor-pointer transition-colors duration-300 hover:bg-blue-200 hover:text-blue-500"
                onClick={compartir}
              >
                Compartir
              </button>
            ...
            <div className="progress mt-2.5 w-full h-2.5 bg-gray-800 rounded-md overflow-hidden">
              <div
                ...
                style={{
                  width: modalProgressPercentage,
                  backgroundColor: "#4d06f5",
                }}
              ></div>
            </div>
            <div className="progress-percentage mt-1.5 text-white">
      ...
      <div className="info-card w-2/5 m-5 p-5 bg-gradient-to-t from-blue-900 to-blue-500 text-white rounded-lg shadow-lg absolute left-5 top-64">
        ...
        <p>
          Oxygen Gaming es una plataforma dedicada a la organización de torneos
          de videojuegos. Ofrecemos una amplia variedad de contenido para los
          entusiastas de los videojuegos, incluyendo:
        </p>
