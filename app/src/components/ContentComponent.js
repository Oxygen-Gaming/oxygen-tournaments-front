...
import oxygen from '@imgs/Logo_Blue.png';
...
const Contenido = () => {
  ...
  return (
    <div className="font-sans bg-blue-900 text-black m-0 p-0 min-h-screen flex flex-col">
      {' '}
      {/* Add min-h-screen and flex classes */}
      ...
      <div className="container p-5 flex justify-center items-center mt-16">
        {' '}
        {/* Change mt-12 to mt-16 to move title down */}
        <h1 className="text-white text-4xl font-bold ml-80">Contenido</h1>{' '}
        {/* Change ml-10 to ml-20 to move it further to the right */}
      </div>
      <div className="flex-grow flex justify-between mt-12">
        {' '}
        {/* Add mt-12 to create more space below "Contenido" */}
        <div className="info-card w-2/5 ml-10 m-5 p-5 bg-gradient-to-t from-blue-900 to-blue-500 text-white rounded-lg shadow-lg">
          {' '}
          {/* Add ml-10 to create space on the left */}
          <h2 className="text-2xl">Sobre Oxygen Gaming</h2>
          <p>
            Oxygen Gaming es una plataforma dedicada a la organización de
            torneos de videojuegos. Ofrecemos una amplia variedad de contenido
            para los entusiastas de los videojuegos, incluyendo:
          </p>
          <ul className="list-disc list-inside">
            ...
            <li>
              Noticias y actualizaciones sobre el mundo de los videojuegos
            </li>
          </ul>
          <p>
            Únete a nuestra comunidad y participa en nuestros torneos para ganar
            premios y reconocimiento. ¡Mantente conectado y sigue mejorando con
            Oxygen Gaming!
          </p>
        </div>
        <table className="ranking-table w-1/5 m-5 mr-10 border-collapse shadow-lg rounded-lg overflow-hidden">
          {' '}
          {/* Add mr-10 to separate from the right */}
          <thead>
            <tr>
              <th className="bg-blue-500 text-white font-bold p-2.5">
                Posición
              </th>
      ...
      <div className="video-row flex justify-between flex-nowrap overflow-hidden mt-24 mb-24 w-full px-10 gap-4">
        {' '}
        {/* Add gap-4 to reduce space between video cards */}
        <div
        ...
        >
          ...
          <div className="video-info flex flex-col justify-between w-2/3 pl-2.5">
            ...
            {/* Change text color to white and position at top right */}
      ...
      {modalVisible && (
        <div className="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-75">
          <div className="modal-content p-5 rounded-lg shadow-lg relative w-3/4 h-3/4">
            {' '}
            {/* Make the modal larger and remove white background */}
            <button
            ...
            {/* Move share button higher */}
          </div>
        </div>
      )}
      <footer className="w-full bg-neutral-900 mt-24">
        {' '}
        {/* Add mt-24 to create space above the footer */}
        <div
          id="contenido_footer"
