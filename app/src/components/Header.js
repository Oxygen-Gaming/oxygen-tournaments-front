  ...
  return (
    <header className="lg:flex justify-between hidden items-center px-4 py-4 md:px-6 bg-[#18538a] text-[18px] font-['Roboto_Condensed']">
      ...
      <nav className="flex items-center gap-2">
        ...
        <a href="/competition" className={`text-white no-underline px-2 py-2 rounded transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:bg-white/10 font-['Roboto_Condensed',sans-serif] ${location.pathname === '/competition' ? 'bg-blue-600' : ''}`}>Competiciones</a>
        ...
        <a href="/ventajas" className={`text-white no-underline px-2 py-2 rounded transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:bg-white/10 font-['Roboto_Condensed',sans-serif] ${location.pathname === '/rewards' ? 'bg-blue-600' : ''}`}>Ventajas</a>
      </nav>
