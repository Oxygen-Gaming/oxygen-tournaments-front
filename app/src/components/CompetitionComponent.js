...
const Competition = () => {
  ...
  const modalStyle =
    'bg-[#002f5f] text-white p-5 rounded-lg w-[85%] max-w-[1300px] h-[75%] overflow-hidden fixed'; // Keep this for info modal
  const buttonModalStyle =
    'bg-[#002f5f] text-white p-5 rounded-lg w-[40%] max-w-[500px] h-[40%] overflow-hidden fixed'; // Smaller size for button modal
  const bracketModalStyle =
    'bg-gray-900 text-white p-5 rounded-lg w-[90%] max-w-[1400px] h-[85%] fixed'; // Adjusted size for bracket modal
  const modalContentStyle = 'overflow-y-auto h-full pr-4'; // New style for modal content
  const buttonStyle =
    'px-4 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 border-2 border-white text-white bg-transparent hover:bg-white hover:text-blue-900 w-full'; // Ensure buttons have the same size
  const smallButtonStyle =
    'px-3 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 border-2 border-white text-white bg-transparent hover:bg-white hover:text-blue-900'; // Slightly larger button style
  const noZoomButtonStyle =
    'px-3 py-2 rounded-lg border-2 border-white text-white bg-transparent hover:bg-white hover:text-blue-900'; // Button style without zoom
  ...
  const underlineAnimation =
    "after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-full after:h-1 after:bg-yellow-400 after:transition-transform after:duration-300 after:scale-x-0 hover:after:scale-x-100"; // New underline animation
  const zoomAnimation = 'animate-pulse'; // New animation class
  const bounceAnimation = 'animate-bounce'; // New animation class
  const hoverEffect =
    'transition-transform transform hover:scale-105 border-2 border-white text-white bg-transparent hover:bg-white hover:text-blue-900 duration-500'; // Updated hover effect class with slower duration
        ...
        {rounds.map((round, index) => (
          <div key={index} className="flex flex-col flex-grow">
            {Array.from({ length: round / 2 }).map((_, matchIndex) => (
              <div
                key={matchIndex}
                className="flex flex-col justify-center m-2 p-1 flex-grow relative"
              >
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-900 text-white p-4">
        <div className="grid grid-cols-3 gap-8 items-center">
          ...
          <div className="space-y-32 relative">
            <div className="p-4 bg-gray-600 rounded-lg text-center">
              Finalista
            </div>
  ...
  return (
    <div className="bg-blue-900 text-white overflow-x-hidden font-['Roboto_Condensed',sans-serif]">
      ...
      {/* BANNER */}
      <div
        className="w-11/12 mx-auto h-80 bg-cover bg-center rounded-lg transition-all duration-1000"
        style={{ backgroundImage: `url(${images[currentImage].src})` }}
      >
        <div className="w-full h-full flex items-center justify-center bg-black bg-opacity-50 rounded-lg"></div>
      </div>
      ...
      <div className="container mx-auto p-5">
        {showGeneralView && !showAllTournaments && !selectedGame && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div
              className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
              onClick={() => handleCardClick('League of Legends Tournament')}
            >
              <img
                src={LeagueOfLegends}
              ...
              />
              <h2 className="text-[#4ade80] text-2xl font-bold mb-2">
                League of Legends Tournament
              </h2>{' '}
              {/* Highlighted tournament title */}
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleViewAll('League of Legends');
                }}
            ...
            <div
              className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
              onClick={() => handleCardClick('Valorant Tournament')}
            >
              <img
                src={Valorant}
                alt="Valorant"
            ...
            <div
              className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
              onClick={() => handleCardClick('Rocket League Tournament')}
            >
              <img
                src={RocketLeague}
                alt="Rocket League"
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() =>
                  handleCardClick('League of Legends Tournament 1')
                }
              >
                <img
                  src={LeagueOfLegends}
                ...
                />
                <h2 className="text-[#4ade80] text-2xl font-bold mb-2">
                  League of Legends Tournament 1
                </h2>{' '}
                {/* Highlighted tournament title */}
                <p className="text-sm mb-2">Fecha de Inicio: 01/12/2023</p>
                <div className="flex items-center mb-2">
              ...
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() =>
                  handleCardClick('League of Legends Tournament 2')
                }
              >
                <img
                  src={LeagueOfLegends}
                ...
                />
                <h2 className="text-[#4ade80] text-2xl font-bold mb-2">
                  League of Legends Tournament 2
                </h2>{' '}
                {/* Highlighted tournament title */}
              ...
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() =>
                  handleCardClick('League of Legends Tournament 3')
                }
              >
                <img
                  src={LeagueOfLegends}
                ...
                />
                <h2 className="text-[#4ade80] text-2xl font-bold mb-2">
                  League of Legends Tournament 3
                </h2>{' '}
                {/* Highlighted tournament title */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() => handleCardClick('Valorant Tournament 1')}
              >
                <img
                  src={Valorant}
                  alt="Valorant"
              ...
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() => handleCardClick('Valorant Tournament 2')}
              >
                <img
                  src={Valorant}
                  alt="Valorant"
              ...
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() => handleCardClick('Valorant Tournament 3')}
              >
                <img
                  src={Valorant}
                  alt="Valorant"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() => handleCardClick('Rocket League Tournament 1')}
              >
                <img
                  src={RocketLeague}
                  alt="Rocket League"
              ...
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() => handleCardClick('Rocket League Tournament 2')}
              >
                <img
                  src={RocketLeague}
                  alt="Rocket League"
              ...
              <div
                className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                onClick={() => handleCardClick('Rocket League Tournament 3')}
              >
                <img
                  src={RocketLeague}
                  alt="Rocket League"
        ...
        {selectedGame && (
          <>
            ...
            {/* Highlighted selected game title */}
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div
                  className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                  onClick={() =>
                    handleCardClick(`${selectedGame} Tournament 1`)
                  }
                >
                  <img
                    src={
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div
                  className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg"
                  onClick={() =>
                    handleCardClick(`${selectedGame} Tournament 2`)
                  }
                >
                  <img
                    src={
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                {/* Example: */}
                <div
                  className="bg-[#003f7f] rounded-lg p-5 transition-transform transform hover:scale-105 shadow-lg opacity-50"
                  onClick={() =>
                    handleCardClick(`${selectedGame} Tournament 3`)
                  }
                >
                  {' '}
      ...
      {selectedCard === 'League of Legends Tournament' && showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className={buttonModalStyle}>
            ...
            {/* Highlighted modal content title */}
            <div className="flex flex-col gap-6 mt-4">
              <button className={buttonStyle} onClick={handleInfoClick}>
                Información del torneo
              </button>
              <button className={buttonStyle} onClick={handleRegistrationClick}>
                Inscripción
              </button>{' '}
              {/* Updated button */}
              <button className={buttonStyle} onClick={handleBracketClick}>
                Ver Bracket
              </button>{' '}
              {/* Updated button */}
            </div>
            <button
              onClick={closeModal}
              className={`mt-8 ${smallButtonStyle} mx-auto block`}
            >
              Cerrar
            </button>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className={modalStyle}>
            <div className={modalContentStyle}>
              <img
                src={
                  selectedCard === 'League of Legends Tournament'
                    ? LeagueOfLegends
                    : selectedCard === 'Valorant Tournament'
                      ? Valorant
                      : RocketLeague
                }
                alt={selectedCard}
              ...
              {/* Highlighted modal content title without underline animation */}
              <div className="flex flex-col items-center w-full text-center">
                ...
                {/* Highlighted section title without color */}
                <div className={`${panelStyle} text-left mb-4`}>
                  {' '}
                  {/* Align text to the left and add margin-bottom */}
                  <ul className="list-disc list-inside ml-5">
                    {' '}
                    {/* Use list for better visual presentation */}
                ...
                <div className={`${panelStyle} text-left mb-4`}>
                  ...
                  <ul className="list-disc list-inside ml-5">
                    ...
                    {/* Use list for better visual presentation */}
                    <li>
                      Juego limpio - No se permite el uso de hacks, trampas o
                      cualquier forma de conducta antideportiva.
                    </li>
                    <li>
                      Respeto entre jugadores - Cualquier tipo de comportamiento
                      ofensivo, racista o agresivo resultará en descalificación.
                    </li>
                    <li>
                      Puntualidad - Los jugadores deben estar presentes en sus
                      partidas según el horario establecido.
                    </li>
                    <li>
                      Desconexiones y problemas técnicos - Se dará un tiempo de
                      gracia en caso de desconexiones involuntarias.
                    </li>
                    <li>
                      Decisiones de los organizadores - Cualquier situación no
                      contemplada será resuelta por el equipo de administración
                      del torneo.
                    </li>
                  </ul>
                </div>
                ...
                <div className={`${panelStyle} text-center mb-4`}>
                  {' '}
                  {/* Center align text and add margin-bottom */}
                  <p className="text-red-500 font-bold">No inscrito</p>{' '}
                  {/* Highlighted and colored text */}
                  <p>
                    ¡Prepárate para la batalla y demuestra que eres el mejor!
                    Inscríbete ahora y sé parte de esta competencia épica. Para
                    más información, síguenos en nuestras redes sociales y
                ...
                <div className={`${panelStyle} text-left mb-4`}>
                  ...
                  <ul className="list-disc list-inside ml-5">
                    ...
                    {/* Highlighted text */}
                    <li>
                      Todos los participantes competirán en rondas preliminares.
                    </li>
                    <li>
                      Se jugará un sistema de puntos o eliminación simple según
                      el juego.
                    </li>
                    <li>
                      Los mejores jugadores o equipos avanzarán a la siguiente
                      fase.
                    </li>
                    <p className="font-bold">Eliminación Directa:</p>{' '}
                    {/* Highlighted text */}
                    <li>
                      Los clasificados se enfrentarán en un formato de
                      eliminación directa.
                    </li>
                    <li>
                      Cada partida será al mejor de [X] rondas/mapas según la
                      mecánica del juego.
                    </li>
                    ...
                    {/* Highlighted text */}
                    <li>
                      Los dos mejores jugadores o equipos se enfrentarán en un
                      enfrentamiento definitivo.
                    </li>
                    <li>
                      El formato será al mejor de [X] partidas para definir al
                      campeón.
                    </li>
                    <li>
                      Se transmitirá en vivo con comentaristas y cobertura en
                ...
                <div className={`${panelStyle} text-center mb-4`}>
                  ...
                  {/* Center align text */}
                  <p>
                    ¡Bienvenidos al Torneo de OxygenGaming! Bienvenidos al
                    torneo definitivo donde la habilidad, la estrategia y la
                    adrenalina se combinan en una competencia sin igual.
                    OxygenGaming te trae un evento épico donde los mejores
                    jugadores se enfrentarán por la gloria, la competencia y,
                    por supuesto, increíbles premios.
                  </p>
                ...
                <div className={`${panelStyle} text-center mb-4`}>
                  ...
                  {/* Center align text */}
                  <p>
                    Los mejores jugadores no solo ganarán respeto y
                    reconocimiento, sino también premios exclusivos:
                  </p>
                  <p className="text-4xl font-bold text-yellow-400">
                    🥇 1er Lugar: 100$
                  </p>{' '}
                  {/* Highlight 1st place prize */}
                  <p className="text-3xl font-semibold text-gray-300">
                    🥈 2do Lugar: 50$
                  </p>{' '}
                  {/* Highlight 2nd place prize */}
                  <p className="text-2xl font-medium text-gray-500">
                    🥉 3er Lugar: 25$
                  </p>{' '}
                  {/* Highlight 3rd place prize */}
                </div>
              </div>
              <button
            ...
            <div className="flex relative z-10">
              <div className="w-1/4 pr-2">
                ...
                <div className="mb-16 relative">
                  ...
                  {/* Moved line between Team 3 and Team 4 */}
                </div>
                <div className="mb-16 relative">
              ...
              <div className="w-1/4 pr-2">
                <div className="mt-20 mb-16 relative">
                  <div className="mb-1 text-xs text-blue-400 pl-2">
                    Semifinal 1
                  </div>
                  <div className="bg-gray-800 border border-gray-700 text-xs rounded overflow-hidden shadow-lg">
                ...
                <div className="mt-60 mb-16 relative">
                  {' '}
                  {/* Increased margin-top to move Semifinal 2 further down */}
                  <div className="mb-1 text-xs text-blue-400 pl-2">
                    Semifinal 2
                  </div>{' '}
                  {/* Moved Semifinal 2 here */}
                  <div className="bg-gray-800 border border-gray-700 text-xs rounded overflow-hidden shadow-lg">
                    <div className="border-b border-gray-700 py-2 px-3 flex justify-between items-center hover:bg-gray-700 transition-colors duration-150">
                      <span className="font-bold text-gray-400">
                        Ganador Grupo 3
        ...
        >
          ...
          >
            <a href="https://oxygengaming.es/">
              <img
                id="logo_footer"
                src="https://oxygengaming.es/wp-content/uploads/2022/06/Logo-OG200.png"
            ...
            <div className="flex gap-4 mt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex justify-center items-center w-10 h-10 rounded-full no-underline transition-all"
              >
                <img
                  src={Twitter}
                  alt="Twitter"
