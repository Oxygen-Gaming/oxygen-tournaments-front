...
const Footer = () => {
  return (
    <div id="contenido_footer" className="flex flex-col items-center justify-center bg-[#1a191d] px-8 py-6 w-full lg:h-[520px]">
        <div id="arriba_footer" className="flex flex-col items-center w-full gap-8 md:gap-12 lg:flex-row lg:items-start lg:justify-center lg:gap-[8vh] lg:mb-[100px] xl:gap-[12vh]">
            ...
            <div id="redes_sociales" className="flex flex-col items-center text-center">
                ...
                <div className="social-links flex gap-4">
                    ...
                    <a href="https://instagram.com/GamingOxygen" aria-label="Instagram de Oxygen Gaming" className="flex justify-center items-center text-white bg-[#222] border-2 border-[#1AA9FF] w-10 h-10 rounded-full transition-all duration-300 hover:text-[#e4405f] text-[20px] md:w-[70px] md:h-[70px] md:text-[30px] lg:w-[50px] lg:h-[50px] lg:text-[20px]">
                        <i className="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.tiktok.com/@oxg_esports?lang=es" aria-label="TikTok de Oxygen Gaming" className="flex justify-center items-center text-white bg-[#222] border-2 border-[#1AA9FF] w-10 h-10 rounded-full transition-all duration-300 hover:text-[#69c9d0] text-[20px] md:w-[70px] md:h-[70px] md:text-[30px] lg:w-[50px] lg:h-[50px] lg:text-[20px]">
                        <i className="fab fa-tiktok"></i>
                    </a>
                    <a href="https://discord.gg/Udsstfpeze" aria-label="Discord de Oxygen Gaming" className="flex justify-center items-center text-white bg-[#222] border-2 border-[#1AA9FF] w-10 h-10 rounded-full transition-all duration-300 hover:text-[#7289da] text-[20px] md:w-[70px] md:h-[70px] md:text-[30px] lg:w-[50px] lg:h-[50px] lg:text-[20px]">
