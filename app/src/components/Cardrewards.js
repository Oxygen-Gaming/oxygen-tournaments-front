...
const Card = ({ image, title, points }) => {
  return (
    <div className="card w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 h-40 bg-gradient-to-t from-[#18538a] to-[#1e90ff] rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
