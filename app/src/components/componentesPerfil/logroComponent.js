        ...
        <div className="flex flex-wrap w-screen gap-[20px] lg:w-[50%] justify-center items-center mt-[50px]">
            ...
            <div className="flex flex-wrap justify-center w-screen gap-[20px]">
                ...
                {variable.map((logro, index) => (
                    <div key={index} className="bg-[#1c1c1c] min-[568px]:w-[65vh] sm:min-h-[80vh] min-h-[50vh] lg:min-h-[50vh] md:w-[300px] md:min-h-[70%] md:p-[20px] w-[40vh] p-[30px] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]">
