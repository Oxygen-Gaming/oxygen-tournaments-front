...
const CuentasJuego = () => {
    ...
    return (
        <div className="flex flex-col gap-[20px] w-full justify-center items-center overflow-x-hidden py-5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-[50px] static sm:p-[30px] px-[80px]">
                {cuentas.map((cuenta, index) => (
                    <div key={index} className="bg-gradient-to-t w-[40vh] min-[568px]:w-[100vh] sm:min-h-[150vh] sm:w-[70vh] min-h-[70vh] lg:min-h-[70vh] lg:w-[40vh] p-[30px] md:w-[300px] md:min-h-[70%] md:p-[20px] from-[#18538a] to-[#1e90ff] text-white rounded-[15px]">
