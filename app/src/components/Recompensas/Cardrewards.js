...
const Card = ({ image, title, points }) => {
  return (
    <div className="card w-84 h-96 bg-gradient-to-b from-blue-900 to-blue-600 rounded-xl shadow-md overflow-hidden transform transition duration-300 hover:scale-105 group">
